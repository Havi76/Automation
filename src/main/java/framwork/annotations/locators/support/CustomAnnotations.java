package framwork.annotations.locators.support;

import framwork.annotations.locators.Find;
import framwork.annotations.locators.Finds;
...
public class CustomAnnotations extends AbstractAnnotations {
    ...
    protected void assertValidAnnotations() {
        ...
        framwork.annotations.locators.FindAll findAll = field.getAnnotation(framwork.annotations.locators.FindAll.class);
        FindBy findBy = field.getAnnotation(FindBy.class);
        Finds customFindBys = field.getAnnotation(Finds.class);
        framwork.annotations.locators.FindAll customFindAll = field.getAnnotation(framwork.annotations.locators.FindAll.class);
